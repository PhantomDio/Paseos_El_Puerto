        ...
        <ul>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="/paseos_el_puerto/Embarcaciones/inserta_cliente.jsp">Registrar</a></li>
                    <li><a href="/paseos_el_puerto/Embarcaciones/actualiza_cliente.jsp">Modificar</a></li>
                </ul>
            </li>
            <li class="dropdown">
        ...
        <div class="table-container">
            <table>
                ...
                <%
                    ...
                    List<Embarcaciones> lista = (List<Embarcaciones>) request.getAttribute("lista");
                ...
                <tr>
                    ...
                    <td><%= embarcacion.getApellidoP() %></td>
                    <td><%= embarcacion.getApellidoM() %></td>
                    <td><%= embarcacion.getDireccion() %></td>
                    <td><%= embarcacion.getTelefono() %></td>
                    <td><%= embarcacion.getEmail() %></td>
                    <td><%= embarcacion.getFecha_nac() %></td>
                </tr>
                <% } else if (lista != null && !lista.isEmpty()) {
                    for (Embarcaciones prop : lista) {
                %>
                <tr>
                ...
                <% }
                        ...
                        session.removeAttribute("embarcacion");
                %>
                <tr>
                    <td colspan="8"><h1>No hay embarcaciones a mostrar</h1></td>
                </tr>
                <% } %>
                </tbody>
            </table>
