    ...
    <ul class="cont_ul">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="/paseos_el_puerto/Clientes/inserta_propietario.jsp">Registrar</a></li>
                <li><a href="/paseos_el_puerto/Clientes/actualiza_propietario.jsp">Modificar</a></li>
            </ul>
        </li>
        <li class="dropdown">
            <a href="#">Clientes</a>
...
<script>
    function autollenar() {
        ...
        var url = '/paseos_el_puerto/ServletCliente?op=Autollenado&id=' + id;
...
<section class="container">
    <div class="parallax-content">
        ...
        <form action="/paseos_el_puerto/ServletCliente" method="post" onsubmit="return validarFormulario()">
            <p>ID: <input type="text" name="id_cliente" id="id" onblur="autollenar()"></p>
            <% if (cliente != null) { %>
            <p>Nombre: <input type="text" value="<%=cliente.getNombre()%>" name="nombre"></p>
            <p>Apellido Paterno: <input type="text" value="<%=cliente.getApellidoP()%>" name="ap_pat"></p>
            <p>Apellido Materno: <input type="text" value="<%=cliente.getApellidoM()%>" name="ap_mat"></p>
            <p>Dirección: <input type="text" value="<%=cliente.getDireccion()%>" name="direccion"></p>
            <p>Teléfono: <input type="text" value="<%=cliente.getTelefono()%>" name="telefono"></p>
            <p>Correo: <input type="text" value="<%=cliente.getEmail()%>" name="email"></p>
            <p>Fecha de nacimiento: <input type="text" value="<%=cliente.getFecha_nac()%>" name="fecha_nac" placeholder="(yyyy-mm-dd)"></p>
            <% } else { %>
